...
json_path = 'diagnostic_per_image.json'

# Path to your images directory
images_dir_train = 'train'
images_dir_test = 'test'

# Path to save the mask images for train and test
masks_folder_train = 'train_masks'
masks_folder_test = 'test_masks'
...
for item in data:
    ...
    if os.path.exists(os.path.join(images_dir_train, f"{image_id}.jpg")):
        images_dir = images_dir_train
        masks_folder = masks_folder_train
    elif os.path.exists(os.path.join(images_dir_test, f"{image_id}.jpg")):
        images_dir = images_dir_test
        masks_folder = masks_folder_test
    else:
        raise ValueError(f"Image not found in train or test directory: {image_id}")
